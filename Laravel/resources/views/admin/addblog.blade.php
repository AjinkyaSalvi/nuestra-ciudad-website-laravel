            ...
            <div class="content_wrap"><br>
              ...
              <br><br>
                <div class="userd_events_grid">
                   <h2 class="orange_italic"> Add New Blog</h2>
                   <br>
                   <form class='login_form' action='{{ route('insertblog')}}' method='post'>
                     @csrf
                          <br>
                                                        <label for='event_namee' class='grey_color'>Blog Name:</label><br><br>
                                                        <input type='text' name='blog_namee' class='login_input' required ><br><br>

                                                        <label for='event_date' class='grey_color'>Blog Date: </label><br><br>
                                                        <input type='date' name ='blog_date' class='login_input'  ><br><br>

                                                         <label for='event_description' class='grey_color'>Blog Description: </label><br><br>
                                <textarea name='blog_description' class='dashboard_input' required>

                                </textarea>
                                <br>
                                <input type='submit' value='Add Blog' name='blog_add_btn' class='login_button' id='white' >
                    </form>
                </div>
            </div>
